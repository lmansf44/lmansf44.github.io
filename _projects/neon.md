...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project_photos/neon_workflow.jpg" class="img-fluid rounded" zoomable=true%}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project_photos/neon_poster.jpg" class="img-fluid rounded" zoomable=true%}
    </div>
</div>
<div class="caption">
