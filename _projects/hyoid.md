...
img: assets/img/tuamotu_cover.jpg
importance: 3
category: past
---
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/hyoid.png" title="example image" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    The tiny hyoid bone of a Semipalmated Sandpiper!
</div>


<div class="caption">
    Cover photo: A Tuamotu sandpiper (Prosobonia parvirostris). Credit: James Eaton, accessed from Avicommons.
</div>